...
function ChoiceForMultipleChoiceQuestion({
  singleQuestion,
  questionIndex,
  ...
  function onCorrectAnswerChange(choiceIndex:number, questionIndex:number) {
    singleQuestion.choices[choiceIndex].isCorrect = !singleQuestion.choices[choiceIndex].isCorrect
    handleQuestionUpdate(singleQuestion, questionIndex);
  }
      ...
      <div className="border border-gray-200 rounded-md p-4 w-full ">
        ...
        {choices.map((singleChoice, choiceIndex) => (
          ...
          >
            ...
            onChange={() => onCorrectAnswerChange(choiceIndex, questionIndex)}
...
export default ChoiceForMultipleChoiceQuestion;
