...
import { ComboBox } from "./TagComboBox";
export interface quizTitleProps {
  onChangeQuizInfo: (title: string, isShuffled:boolean, timeToPlay: number) => void;
  onTaggingQuiz: (tagIds: string[]) => void
}


function QuizCreateTitle({ onChangeQuizInfo, onTaggingQuiz }: quizTitleProps) {
  ...
  return (
    <div className="flex gap-10">
      <div className="flex flex-col p-5 gap-5 border border-rose-700 rounded-md justify-between">
      ...
      <ComboBox handleTaggingQuiz={onTaggingQuiz}></ComboBox>
    </div>
  );
}
