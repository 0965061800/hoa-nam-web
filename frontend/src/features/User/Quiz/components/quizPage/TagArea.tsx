...
import { handleGetTags } from "@/features/Admin/Quiz/services/apis/handle";
import { TagDtoForList } from "@/features/Admin/Quiz/types/interfaces";
...
export function TagArea({handleTaggingQuiz}: TagComboBoxProps) {
