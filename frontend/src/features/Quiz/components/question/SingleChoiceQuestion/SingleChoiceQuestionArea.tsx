...
import ChoiceForSingleChoiceQuestion from "./ChoiceForSingleChoiceQuestion";
...
const SingleChoiceQuestionArea = ({
  questionIndex,
  question,
  quizQuestions,
  endOfListRef,
...
//code like this will making 2 instance of choice
// useEffect(() => {
...
export default SingleChoiceQuestionArea;
